...
export const CaseStudyView = ({ setModalData }) => {
    ...
    const caseStudyProjects = projects.filter(
        (project) => project.caseStudy === 'true',
    );
                        ...
                        <div
                            ...
                            onClick={() =>
                                setModalData({
                                    type: 'case study',
                                    data: {
                                        name: caseStudyProjects[index].name,
                                    },
                                })
                            }
                        >
        ...
        <div className="main-container">
            ...
            <div className="csv-container">
                ...
                >
                    ...
                    <div
                        className="text-box-content scrollable"
                        style={{ alignItems: 'flex-start' }}
                        ref={capstoneContainerListener}
            ...
            <div
                className="avatar-container csv-avatar"
                style={{ bottom: '0px' }}
            >
