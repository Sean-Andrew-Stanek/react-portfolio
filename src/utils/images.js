export const images = {
    ...
    namePlate: '/Name-Plate-250-25.png',
    portrait: '/Portrait-300-300.png',
    ...
    backgrounds: [
        '/background-image-v2.png',
        '/Signpost-Background-450-300.png',
    ],
    buttonBackground: '/Spear-Border-1024-1024.png',
    chatButton: '/Nav-Bar-Chat-Button.png',
    drakeBackground: '/Drake-Background.png',
    drakeForeground: '/Drake-Foreground.png',
    ...
    namePlateBackground: '/Name-Plate-Background-250-25.png',
