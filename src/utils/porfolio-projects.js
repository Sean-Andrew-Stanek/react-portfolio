...
export const projects = [
    {
        ...
        summary:
            'A backend function built in Python and hosted on Azure, this project is the backend for the Chatbot functionality of my portfolio website.',
        links: {
            repository:
                'https://github.com/Sean-Andrew-Stanek/PortfolioChatBot',
    ...
    //Pokedex Project
    {
        ...
        summary:
            'A simple JavaScript program utilizing the PokeAPI to fetch, sort, and display data about Pokemon. It displays my proficiency in DOM manipulation, Ajax, and asynchronous behavior.',
        links: {
    ...
    //React Portfolio
    {
        ...
        summary:
            'SPA Portfolio developed using React-Vise base learning to move away from Create-React-App.  The portfolio is designed to be dynamically created, modular-based where it can be modified through a few JSON files.',
        links: {
    ...
    //Movie API, Client using React
    {
        ...
        links: {
            'client repository':
                'https://github.com/Sean-Andrew-Stanek/movie_api_client',
